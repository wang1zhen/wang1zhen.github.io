...
*** 配置方法
    ...
    #+BEGIN_SRC conf :tangle ~/.config/mpv/script-opts/modernz.conf :mkdirp yes
      # 外观
      language=en                         # 英文界面
...
*** 配置方法
    ...
    #+BEGIN_SRC conf :tangle ~/.config/mpv/script-opts/autoload.conf :mkdirp yes
...
*** 配置方法
    ...
    #+BEGIN_SRC conf :tangle ~/.config/mpv/script-opts/playlistmanager.conf :mkdirp yes
      # 主要快捷键
